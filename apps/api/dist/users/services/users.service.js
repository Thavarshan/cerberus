...
let UsersService = exports.UsersService = class UsersService {
    ...
    async create(dto) {
        if (await this.existsByEmail(dto.email)) {
            throw new user_already_exists_exception_1.UserAlreadyExistsException('email', dto.email);
        }
        if (await this.existsByUsername(dto.username)) {
            throw new user_already_exists_exception_1.UserAlreadyExistsException('username', dto.username);
        }
