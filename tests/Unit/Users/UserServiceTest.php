...
use Cerberus\Interfaces\Users\UserRepository;
...
class UserServiceTest extends TestCase
{
    ...
    public function testFindUserByUsername(): void
    {
        ...
        $this->assertSame($user, $service->findByUsername('johnDoe'));
    }

    public function testFindUserByUsernameThrowsExceptionIfUserNotFound(): void
    {
        $this->expectException(UserNotFoundException::class);
